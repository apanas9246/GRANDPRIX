...
class Main:
    ...
    def __init__(self):
        # Phase by value
        self.cur_id = c.ID_WALL #calls id as wall at beginning

        self.cur_phase = p_wall.P_Wall() #phase file = wall at beginning
    ...
    def run_main(self):
        ...
        # Calls current state
        self.cur_phase.run_phase(rc, self.__depth_image, self.__color_image, self.__lidar_scan)#runs the phase 
